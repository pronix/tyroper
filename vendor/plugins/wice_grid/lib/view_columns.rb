module Wice
  ...
  class ViewColumn < Struct.new(:attribute_name, :column_name, :td_html_attrs, :cell_rendering_block) #:nodoc:
    ...
    attr_accessor :grid, :css_class, :table_name, :main_table, :model_class, :no_filter, :custom_filter,
      :in_html, :in_csv, :helper_style, :helper_style, :table_alias, :custom_order
